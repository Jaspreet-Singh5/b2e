            ...
            {isShowOrders ? (
                <div>
                    <div className="component__header flex-between">
                        ...
                        <div className="tabs">
                            <button className="tab tab--active" ref={ordersRef} onClick={tabHandler}>
                                Orders
                            </button>
                            <button className="tab" ref={tradesRef} onClick={tabHandler}>
                                Trades
                            </button>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    {myOpenOrders?.map(order => (
                                        <tr key={order.id}>
                                            ...
                                            <td>
                                                <button className="button--sm" onClick={e => cancelOrderHandler(e, order.id)}>
                                                    Cancel
                                                </button>
                                            </td>
                                        </tr>
